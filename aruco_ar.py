...
parser.add_argument('--video', help='Ronaldo.mp4', default='Ronaldo.mp4')           
# parser.add_argument('--video', help='video.mp4', default='video.mp4')           
...
while True:
    ...
    scale_percent = (500/frame.shape[0])*100
    width = int(frame.shape[1] * scale_percent / 100)
    height = int(frame.shape[0] * scale_percent / 100)
    dim = (width, height)
    frame = cv2.resize(frame, dim, interpolation = cv2.INTER_AREA)
    width2 = int(source.shape[1] * scale_percent / 1000)
    height2 = int(source.shape[0] * scale_percent / 1000)
    dim = (width2, height2)
    ...
    try:
        ...
        print("Error: Image source is not valid (NoneType).")
